...
func dayOfProgrammer(year int32) string {
    ...
    var eight_month_days int32
    if year == 1918 {
        eight_month_days = 230
    }else {
        if (checkLeapYear(year)){
            eight_month_days = 244
        }else{
            eight_month_days = 243
        }
    }    
    day := strconv.Itoa(int(256- eight_month_days))
    fmt.Println("day is ",day)
    return day+".09."+strconv.Itoa(int(year))
